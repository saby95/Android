    ...
    public void buttonclicked(View view){
        ...
        for (int i=0; i<Name1.length(); i++){
            ...
            if((Name1.charAt(i)<'Z') && (Name1.charAt(i)>'A')){
                ...
                Name1 = new StringBuilder(Name1).replace(i,i+1,Character.toString((char)(Name1.charAt(i)+32))).toString();
            }
        }
        ...
        for (int i=0; i<Name2.length(); i++){
            ...
            if((Name2.charAt(i)<'Z') && (Name2.charAt(i)>'A')){
                ...
                Name2 = new StringBuilder(Name2).replace(i,i+1,Character.toString((char)(Name2.charAt(i)+32))).toString();
            }
        }
